...
public enum ErrorCode {
    ...
    MISSING_PROVIDER_USER_ID(HttpStatus.BAD_REQUEST, "MISSING_PROVIDER_USER_ID"),
    INVALID_PARAMETER(HttpStatus.BAD_REQUEST, "INVALID_PARAMETER"),
    INVALID_PROVIDER(HttpStatus.BAD_REQUEST, "INVALID_PROVIDER"),
    EMAIL_NOT_VERIFIED(HttpStatus.BAD_REQUEST, "EMAIL_NOT_VERIFIED"),
