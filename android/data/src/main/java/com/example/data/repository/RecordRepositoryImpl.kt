...
class RecordRepositoryImpl @Inject constructor(
    ...
    override suspend fun getMonthlyRecord(date: LocalDate): Result<MonthlyRecord> =
        recordRemoteDataSource.getMonthlyRecord(date.toString()).mapCatching { it.toDomain() }
}
