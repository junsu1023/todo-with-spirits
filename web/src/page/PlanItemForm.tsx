...
export function PlanItemForm({
	...
	const handleSave = () => {
		...
		if (isRoutine && repeatType === 'WEEKLY' && repeatDaysOfWeek.length === 0)
			return
		if (isRoutine && repeatType === 'MONTHLY' && repeatDaysOfMonth.length === 0)
			return
		...
		onSave({
			...
			repeatType: isRoutine ? repeatType : undefined,
			repeatDaysOfWeek:
				isRoutine && repeatType === 'WEEKLY' ? repeatDaysOfWeek : undefined,
			repeatDaysOfMonth:
				isRoutine && repeatType === 'MONTHLY' ? repeatDaysOfMonth : undefined,
